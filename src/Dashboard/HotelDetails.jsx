...
const PropertyDetails = [
    { name: "24/7 front desk", img: Desk },
    { name: "Parking Included", img: Parking },
    { name: "Restraunt", img: Restraunt },
    { name: "Free Wifi", img: Wifi },
    { name: "Housekeeping", img: Check },
];

const RoomDetails = [
    { name: "Free Self Parking", img: Parking },
    { name: "250 sq ft", img: Sqft },
    { name: "Sleeps 3", img: Person },
    { name: "1 King Bed", img: Bed },
    { name: "Reserve now, pay later", img: Check },
    { name: "Free Wifi", img: Wifi },
];
...
const Overview = () => {
    ...
    const handleBooking = () => {
        navigate("/dashboard/hotel-checkout");
    };
    ...
    return (
        <div className="flex justify-between gap-2">
            <div className="flex flex-col gap-4 w-[70%]">
                ...
                <div className="grid grid-cols-2 grid-rows-3 gap-y-2 w-[500px]">
            ...
            <div className="flex flex-col gap-3">
                <div className="flex justify-end gap-3">
                    ...
                    <button
                        className="bg-[#24293D] text-white w-[135px] h-[40px] rounded"
                ...
                <div className="flex gap-2 justify-between border border-[#3232323D] w-[650px] h-[340px] p-7 rounded">
                    <div className="flex flex-col gap-3 text-[16px]">
                        ...
                        <span className="text-[#FA4615] underline cursor-pointer">
                            More Details
                        </span>
                    </div>
                    <div className="flex flex-col gap-2">
...
const Accessibility = () => <div>Accessibility</div>;
...
const HotelDetails = () => {
    ...
    return (
        <div className="p-10 m-10 mt-0">
            <div className="flex flex-col gap-3">
                <div className="grid grid-cols-3 gap-x-4 gap-y-2 h-[362px] grid-flow-row grid-cols-[2fr_1fr_1fr] grid-rows-[1fr_1fr]">
                    <img
                        src={Card3}
                        alt=""
                        className="col-span-1 row-span-2 w-[800px] h-[355px] object-cover rounded"
                    />
                    <img
                        src={Hotel1_1}
                        alt=""
                        className="w-[370px] h-[170px] object-cover rounded"
                    />
                    <img
                        src={Hotel1_2}
                        alt=""
