  ...
  const cardsData = [
    ...
    },
    {
      ...
      description: (
        <div>
          <p className="mb-4">
            We believe that the best communities are built on trust. As a Kee
            Club member, you have the opportunity to share your lifestyle with
            your family and friends and earn exclusive benefits on every
            successful referral.
          </p>
          <p className="mb-2">
            Kee Club offers the following referral rewards to each of its
            members:
          </p>
          <ul className="list-disc ml-6 mb-4">
            <li>
              Loyalty benefits worth 2% of Agreement Value for re-purchase with
              Piramal.{" "}
            </li>
            <li>
              Referral program for the referring customer + 0.65% for the
              referred customer as well
            </li>
          </ul>
    ...
    {
      imageUrl:
        "https://images.pexels.com/photos/13221876/pexels-photo-13221876.jpeg?auto=compress&cs=tinysrgb&w=1200",
      title: "Offers and Promotions",
      subtitle: "",
      description: (
        <div className="space-y-4">
          <p>
            Kee Club believes in putting your needs above everything else. We
            give you access to exclusive deals from premium and PAN-India brands
            like US Polo Assn, Hakkasan, Lenovo, Luxulo, and many more to
            elevate your lifestyle beyond the ordinary and deliver the luxury
            you deserve.
          </p>
          <p>
            Our goal is to bring you the best experiences from across the
            country and add value worth sharing with your social circle.
          </p>
          <p className="text-sm text-gray-500">
            <strong>Disclaimer*</strong>
            <br />
            All offers on Kee Club are valid till promotions last and may change
            from time to time.
          </p>
        </div>
      ),
    ...
    },
    {
      ...
      description: (
        <div className="space-y-4">
          <p>
            There is more to life than daily routines and Kee Club focuses on
            delivering each of its members with impactful engagement that
            enriches their lives through knowledge, care, and action.
          </p>
          <p>
            We bring our members various events and workshops with the best
            collaborators, so that every Kee Club family can get more value and
            lasting memories.
          </p>
        </div>
      ),
    ...
    <div className="w-full min-h-screen bg-[#F5F8FC] flex flex-col items-center justify-center px-4 sm:px-6 md:px-10 lg:px-16 py-10 space-y-16">
      ...
      <div className="max-w-7xl w-full text-center space-y-6 px-2 sm:px-4">
        ...
        <p className="text-[#7B88A8] text-sm sm:text-base md:text-lg">
          Buying a new home requires trust, assurance, quality, and care – all
          of which are an integral part of the Piramal brand. We know that our
          brand is only as strong as what our customers think of us. When you
          recommend us to people that you care about; you encourage us to do
          better.
        </p>
        <p className="text-[#7B88A8] text-sm sm:text-base md:text-lg">
          Our loyalty benefits are designed to help serve you better and cherish
          each and every member of the Piramal family through this program. It
          is our firm belief that the success of our brand rests on your
          happiness and Kee Club is created to pursue this idea with vigor.
        </p>
      </div>
      ...
      <div className="flex flex-col items-center space-y-12 w-full">
        {cardsData.map((item, index) => {
          const { hideButton, buttonText, onButtonClick, ...cardProps } = item;
          const finalProps = hideButton ? cardProps : item;
